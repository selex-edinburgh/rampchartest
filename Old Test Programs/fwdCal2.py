#desktop/testPrograms/fwdCal2.pi   9/9/16
...
pygame.display.set_caption("Fwd Calibrate")     # Window Title
...
#        correctedOdomDistRt2 = correctedOdomDistRt1 + odomAngOffsetRt
        ...
        screen.blit(font.render("Left Odom   Right Odom ",True,white),(15,45))
