...
'''
    This function will set up the serial interface UART used to
...
'''
    This function will handle any rollovers that may occur during runtime.
        ...
        for event in pygame.event.get():
            if event.type == pygame.KEYDOWN:    #detect a key press
                ...
                if event.key == pygame.K_SPACE: #STOP
                    fwd  = 127                  #
                    turn = 127                  #
                if event.key == pygame.K_END:   #STOP
                    fwd  = 127                  #
                    turn = 127                  #
...
#        screen.blit(font.render(str(fwd),True,white),(45,65))
#        screen.blit(font.render(str(turn),True,white),(123,65))
#        screen.blit(font.render(str(turn),True,white),(195,65))
